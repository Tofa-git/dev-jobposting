<div class="pb-4" style="margin-top: -300px">
	<div class="row">
		<div class="col-sm-12 text-center d-flex flex-md-row flex-column justify-content-center">
			<a href="#" class="d-flex align-items-center btn btn-lg btn-primary bg-gradient p-0 rounded-0 shadow-sm mx-4 mt-2 border border-1 border-light" role="button">
				...
				<span class="fs-5 mx-3">Cari Karyawan Nakal</span>
			</a>
			<a href="#" class="d-flex align-items-center btn btn-lg btn-primary bg-gradient p-0 rounded-0 shadow-sm mx-4 mt-2 border border-1 border-light" role="button">
				<div class="bg-midnightBlue bg-gradient p-2">
						...
						<div class="border border-1 border-secondary bg-light rounded-2 mt-4 p-3">
							<form>
								...
								<div class="row mt-2">
									...
									<div class="col-md-8">
										<button type="submit" class="d-flex align-items-center btn btn-lg btn-primary bg-gradient border border-1 border-light p-0 rounded-0 shadow">
