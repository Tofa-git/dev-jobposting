	...
	<div class="container">
		<div class="pb-4 pt-4">
			...
			<div class="text-light text-center">
				Meliputi Seluruh Partner Yang Bekerjasama Dengan RUN8
			</div>
			<div class="mt-4 d-flex flex-column flex-sm-row justify-content-center">
				<h3 class="text-warning fw-bold">Data tidak ditemukan!</h3>
			</div>
			<div class="row">
				<div class="col-12">
					<h2 class="flex-shrink-1 d-flex flex-column flex-sm-row align-items-center">
						<div class="flex-fill pe-4">
							<div style="opacity: 0.25; border-top: 1px solid #eeeeee; height: 1px;"></div>
						</div>
						<div class="flex-shrink-1">
							<a href="#" role="button" class="btn btn-sm btn-outline-primary text-light p-2 px-3">
