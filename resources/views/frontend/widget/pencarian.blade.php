...
<div class="pb-4" style="margin-top: -200px">
	<div class="row">
		<div class="col-sm-12 text-center d-flex flex-md-row flex-column justify-content-center">
			<a href="/register" class="d-flex align-items-center btn btn-lg btn-primary bg-gradient p-0 rounded-3 shadow-sm mx-4 mt-2 border border-1 border-light overflow-hidden" role="button">
			...
			<a href="/register" class="d-flex align-items-center btn btn-lg btn-primary bg-gradient p-0 rounded3 shadow-sm mx-4 mt-2 border border-1 border-light overflow-hidden" role="button">
				<div class="bg-midnightBlue bg-gradient p-2">
		...
		<div class="row">
			...
			<div class="col-md-7">
					<div class="d-flex flex-column h-100 justify-content-center">
						...
						<div class="border rounded-2 mt-2 p-3">
							<form>
								<div class="row mt-1">
									<div class="col-md-3">
										<label for="provinsi" class="small text-secondary">Lokasi Kerja</label>
									</div>
								...
								<div class="row mt-1">
									<div class="col-md-3">
										<label for="bidang" class="small text-secondary">Bidang Pekerjaan</label>
									</div>
									<div class="col-md-9">
								...
								<div class="row mt-1">
									<div class="col-md-3">
										<label for="level" class="small text-secondary">Level Jabatan</label>
									</div>
									<div class="col-md-9">
