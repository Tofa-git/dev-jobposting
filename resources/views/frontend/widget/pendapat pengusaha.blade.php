		...
		<div class="pb-4 pt-4">
			<div class="mt-3 d-flex justify-content-center">
				<h3 class="d-flex align-items-center">
					...
					<span class="px-4">
						Pendapat Pengusaha <span class="text-primary" style="font-family: 'Caveat', cursive; font-size: 22pt; font-weight: bold">Sukses</span>
					</span>
					<div style="width: 50px">
						<div style="border-top: 1px solid #cccccc; height: 1px;"></div>
					</div>
			...
			<div class="text-lighter text-center text-secondary">
				Apa Kata Mereka Yang Sukses Tentang Bisnis RUN8
			</div>
					...
					<h2 class="flex-shrink-1 d-flex flex-column flex-sm-row align-items-center">
						...
						<div class="flex-shrink-1">
							<a href="#" role="button" class="btn btn-sm btn-outline-primary p-2 px-3">
								<span class="me-2">Lihat Pendapat Lainnya</span>
