					...
					<div class="col-md-4 p-3">
						<div class="card bg-grey border">
							<div class="card-body">
								...
								<a href="{{ route('content.content', [$_alasan_pilih->layout->shortname, substr($_alasan_pilih->url, 1)]) }}" class="text-decoration-none rounded-0 p-0 m-0 d-flex align-items-center">
