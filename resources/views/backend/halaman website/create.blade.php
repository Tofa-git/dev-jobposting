				...
				<div class="row mt-2 flex-shrink-1">
					<div class="col-sm-6">
						...
						<div class="input-group">
							<input type="text" name="judul" id="judul" title="Judul Halaman" placeholder="Judul Halaman" class="auto_focus form-control bg-white @error('judul') is-invalid @enderror" required autofocus maxlength="255" value="{{ old('judul') }}" onkeyup="globalFunction.updateJudul(this, '#url_halaman')" />
