<div class="d-flex align-items-stretch flex-grow-1">
	<form action="{{ route('landing-page.update', $data->id) }}" method="post" class="d-flex flex-column flex-grow-1 bg-white rounded-3" onsubmit="return globalFunction.checkSubmission(this)">
		<div class="p-3 flex-grow-1 align-items-stretch">
			...
			<div class="px-3">
				...
				<div class="row mt-1">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<input type="text" name="nama" id="nama" title="Nama Widget" placeholder="Nama Widget" class="form-control bg-white border-grey @error('nama') is-invalid @enderror" required autofocus maxlength="64" value="{{ $data->description }}" />
				...
				<div class="row mt-1">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<input type="text" name="target" id="target" title="Target Widget" placeholder="Target Widget" class="form-control bg-white border-grey @error('target') is-invalid @enderror" value="{{ $data->target }}" required autofocus maxlength="255" />
							<div class="p-2 bg-secondary d-flex rounded-end-2" onclick="globalFunction.clearValue(event)" style="cursor: pointer" title="Hapus">
								<i class="material-icons-outlined align-self-center text-white fs-5">clear</i>
							</div>
						</div>
