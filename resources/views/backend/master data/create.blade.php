<div class="d-flex align-items-stretch flex-grow-1">
	<form action="{{ route('master-data.store') }}" method="post" class="d-flex flex-column flex-grow-1 bg-white rounded-3" onsubmit="return globalFunction.checkSubmission(this)">
				...
				<div class="row">
					...
					<div class="col-sm-9">
						<div class="input-group">
							<input type="text" name="description" id="description" title="Deskripsi master data" placeholder="Deskripsi Master Data" class="auto_focus form-control bg-white @error('description') is-invalid @enderror" required autofocus maxlength="255" />
