			...
			<div class="row">
				...
				<div class="col-sm-9 mt-2">
					<div class="input-group">
						<input type="text" name="description" id="description" title="Nama Group" placeholder="Nama Group" class="auto_focus form-control bg-white @error('description') is-invalid @enderror" required autofocus maxlength="255" />
