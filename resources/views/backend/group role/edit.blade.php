		...
		<div class="px-3 flex-grow-1 align-items-stretch">
			...
			<div class="row">
				...
				<div class="col-sm-9 mt-2">
                    <div class="d-flex">
                        <input placeholder="Deskripsi Master Data" type="text" class="auto_focus rounded-0 form-control input-text @error('description') is-invalid @enderror" id="description" name="description" value="{{ $data->description }}" required />
