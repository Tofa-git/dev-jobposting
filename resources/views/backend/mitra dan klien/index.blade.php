	...
	<div class="flex-shrink-1 bg-light">
		<div class="d-flex border-bottom">
			...
			<div class="p-2 d-flex">
				<button onclick="event.preventDefault(); globalFunction.loadMediumContent(this)" data-attr="{{ route('mitra-dan-klien.create', ['refid'=>@$_REQUEST['refid']]) }}" class="p-1 px-2 d-flex align-items-center btn btn-warning bg-gradient p-0">
