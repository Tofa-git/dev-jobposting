		...
		<div class="p-3 flex-grow-1 align-items-stretch">
			...
			<div class="px-3">
				...
				<div class="row mt-1">
					...
					<div class="col-sm-9">
						<input type="number" name="sequence" id="sequence" placeholder="0" class="auto_focus w-100 form-control input-text @error('sequence') is-invalid @enderror" value="{{ $data->sequence }}" required />
					</div>
				</div>
				<div class="row mt-1">
					<div class="col-sm-3">
					...
					<div class="col-sm-9">
						<div class="d-flex">
							<input type="text" name="shortname" id="shortname" title="Shortname master data" placeholder="Shortname Master Data" class="w-100 form-control input-text @error('shortname') is-invalid @enderror" value="{{ $data->shortname }}" maxlength="32" />
				...
				<div class="row mt-1">
					...
					<div class="col-sm-9">
						<div class="d-flex">
							<input type="text" name="description" id="description" title="Deskripsi master data" placeholder="Deskripsi Master Data" class="w-100 form-control input-text @error('description') is-invalid @enderror" value="{{ $data->description }}" required autofocus maxlength="255" />
							<div class="p-2 bg-secondary d-flex clearValue" style="cursor: pointer" title="Hapus">
								<i class="material-icons-outlined align-self-center text-white fs-5">clear</i>
							</div>
						</div>
